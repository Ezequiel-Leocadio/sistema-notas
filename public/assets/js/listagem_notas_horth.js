$(document).ready(function() {
    ...
    function listar_notas(chave = '', numero = '', nome = '', cnpj = '', data = '',dataVen = '',status='',dataStatus='',filial='') {
        ...
        var dataTable = $('#tabela_nota_horth').DataTable({
    ...
    $('#pesquisarAjaxH').click(function() {
        ...
        $('#tabela_nota_horth').DataTable().destroy();
    ...
    $('#enviarNotaH').on('submit', function(e) {
