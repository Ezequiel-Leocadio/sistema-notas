...
<div class="wrapper">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-info">
            <div class="box-header">
             ...
             <form class="form-horizontal" id="enviarNotaCpd"  action="#" enctype="multipart/form-data" oninput="calc_total();">
              <div class="box-body">
          ...
          <div class="form-group">
           <!-- <div class="col-md-6"> -->
            ...
            <div class="form-group">
                ...
                <div class="col-sm-6">
                    <select id="txtFilialCpd"  name="txtFilialCpd" class="form-control input-md">
            ...
            <div class="box-footer">
              <button type="reset" class="btn btn-default" id="limpar" ><i class="fa fa-times"></i>  Limpar</button>
          ...
          <div id="panel-notas" class="panel panel-primary">
            ...
            <div class="panel-body">
              ...
              <table id="tabela_nota_cpd" class="table table-bordered table-striped table-hover js-basic-example dataTable">
                <thead>
                  <tr>
 ...
 <script src="../public/assets/js/editar_nota_cpd.js" type="text/javascript"></script>
  ...
  <script src="../public/assets/js/listagem_notas_cpd.js" type="text/javascript"></script>
