<?php
	...
	$query2 .= 'and filial LIKE "%'.filter_input(INPUT_POST, 'filial').'%" ';
	...
	$query3 .= 'and filial LIKE "%'.filter_input(INPUT_POST, 'filial').'%" ';
	...
	if($data1 != "Invalido"){
		...
		$query2.= 'and data LIKE "%'.$data1.'%" ';
		$query3.= 'and data LIKE "%'.$data1.'%" ';
	}
...
<h3>Notas CPD Filial '.filter_input(INPUT_POST, 'filial').'</h3>
<p>Relatório de notas Enviadas Para Precificação<p/>
<p>Número de notas: '.$num_linhas2.' </p>
<br>
<p >____________________________<br>'.$usuario.' (CPD)</p><br>
<p style="margin-bottom:600px">____________________________<br>'.$users->nome.' (Precificação)</p>
